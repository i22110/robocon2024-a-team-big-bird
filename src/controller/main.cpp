...
void loop() {
  ...
  controller.load = digitalRead(LOAD_PIN); // LOAD_PINの状態を読み取ってcontroller.loadに保存
  controller.shoot = digitalRead(SHOOT_PIN); // SHOOT_PINの状態を読み取ってcontroller.shootに保存
  controller.forwardL = digitalRead(FORWARD_L_PIN); // FORWARD_L_PINの状態を読み取ってcontroller.forwardLに保存
  controller.reverseL = digitalRead(REVERSE_L_PIN); // REVERSE_L_PINの状態を読み取ってcontroller.reverseLに保存
  controller.forwardR = digitalRead(FORWARD_R_PIN); // FORWARD_R_PINの状態を読み取ってcontroller.forwardRに保存
  controller.reverseR = digitalRead(REVERSE_R_PIN); // REVERSE_R_PINの状態を読み取ってcontroller.reverseRに保存
